...
import { getCancelledOrders, cancelOrder } from "../../../redux/apiRequest";
...
const CancelledOrders = () => {
  ...
  useEffect(() => {
    try {
      getCancelledOrders(user?.accessToken, dispatch, axiosJWT);
    } catch (error) {
        ...
        >
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex space-x-2">
              ...
              >
                The money you paid will be refunded to your account soon.
              </button>
            </div>
          </div>
        </div>
